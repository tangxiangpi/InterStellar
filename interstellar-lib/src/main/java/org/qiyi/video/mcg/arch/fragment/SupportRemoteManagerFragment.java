package org.qiyi.video.mcg.arch.fragment;
...
import org.qiyi.video.mcg.arch.life.ActivityFragLifecycle;
import org.qiyi.video.mcg.arch.log.Logger;
import org.qiyi.video.mcg.arch.remote.IRemoteManager;
import org.qiyi.video.mcg.arch.remote.IRemoteManagerTreeNode;
...
public class SupportRemoteManagerFragment extends Fragment {
    ...
    private void registerFragmentWithRoot(FragmentActivity activity) {
        ...
        rootRequestManagerFragment = InterStellar.getRetriever().getSupportRemoteManagerFragment(activity);
    ...
    public ActivityFragLifecycle getActivityFragLifecycle() {
        return lifecycle;
    }
