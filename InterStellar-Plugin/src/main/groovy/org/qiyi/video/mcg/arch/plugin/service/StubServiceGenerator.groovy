package org.qiyi.video.mcg.arch.plugin.service

import com.android.build.gradle.AppExtension
import groovy.xml.MarkupBuilder
import org.gradle.api.Project
import org.qiyi.video.mcg.arch.plugin.manifest.IManifestParser
import org.qiyi.video.mcg.arch.plugin.manifest.ManifestParser
...
public class StubServiceGenerator implements IServiceGenerator {
    ...
    def static final STUB_SERVICE = 'org.qiyi.video.mcg.arch.stub.CommuStubService$CommuStubService'

    def static final AUTHORITIES="android:authorities"
    def static final DISPATCHER_AUTHORITY="org.qiyi.video.mcg.arch.dispatcher"

    def static final DISPATCHER_SERVICE='org.qiyi.video.mcg.arch.dispatch.DispatcherService'
    def static final DISPTACHER_PROVIDER='org.qiyi.video.mcg.arch.dispatch.DispatcherProvider'
